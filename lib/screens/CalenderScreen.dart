          ...
          child: Column(
            children: <Widget>[
              ...
              TableCalendar(
                ...
                onDayLongPressed: (date, events, hoildays) {
                  // var events=encodeMap(_events,);
                  // listOfEvents=encode(events);
                  flag = true;
                },
              ...
              SingleChildScrollView(
                child: flag == true
                    ? WeekViewDisplay(event: _events,activity: _activity)
                    : Container(
